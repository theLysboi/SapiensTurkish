...
localizations.values = {
    ...
    craftable_unfiredUrnWet = "Yas Vazo",
    craftable_unfiredUrnWet_plural = "Yas Vazolar",
    craftable_unfiredUrnWet_summary = "Icerisinde bir seyler tasiyabileceginiz bir kap.",
    craftable_firedUrn = "Vazo",
    craftable_firedUrn_plural = "Vazolar",
    craftable_firedUrn_summary = "Icerisinde bir seyler tasiyabileceginiz bir kap.",
    craftable_hulledWheat = "Kabuklu Bugday Dolu Vazo",
    craftable_hulledWheat_plural = "Kabuklu Bugday Dolu Vazolar",
    ...
    craftable_mudBrickBuildingResearch = "Kil Tugla Yapi Arastirmasi",
    craftable_mudBrickBuildingResearch_plural = "Kil Tugla Yapi Arastirmalari",
    craftable_mudBrickBuildingResearch_summary = "Kil Tugla Yapi Arastirmasi.",
    ...
    object_flatbreadRotten = "Kuflu Ekmek",
    object_flatbreadRotten_plural = "Kuflu Ekmekler",
    ...
    object_unfiredUrnWet = "Yas Vazo",
    object_unfiredUrnWet_plural = "Yas Vazolar",
    object_unfiredUrnDry = "Vazo",
    object_unfiredUrnDry_plural = "Vazolar",
    object_firedUrn = "Isitilmis Vazo",
    object_firedUrn_plural = "Isitilmis Vazolar",
    object_unfiredUrnHulledWheat = "Kabuklu Bugday (Pismemis)",
    object_unfiredUrnHulledWheat_plural = "Kabuklu Bugdaylar (Pismemis)",
    object_unfiredUrnHulledWheatRotten = "Curuk Kabuklu Bugday (Pismemis)",
    object_unfiredUrnHulledWheatRotten_plural = "Curuk Kabuklu Bugdaylar (Pismemis)",
    object_firedUrnHulledWheat = "Kabuklu Bugday (Pismis)",
    object_firedUrnHulledWheat_plural = "Kabuklu Bugdaylar (Pismis)",
    object_firedUrnHulledWheatRotten = "Curuk Kabuklu Bugday (Pismis)",
    object_firedUrnHulledWheatRotten_plural = "Curuk Kabuklu Bugdaylar (Pismis)",
    ...
    object_unfiredUrnFlour = "Un (Pismemis)",
    object_unfiredUrnFlour_plural = "Unlar (Pismemis)",
    object_unfiredUrnFlourRotten = "Curuk Un (Pismemis)",
    object_unfiredUrnFlourRotten_plural = "Curuk Unlar (Pismemis)",
    object_firedUrnFlour = "Un (Pismis)",
    object_firedUrnFlour_plural = "Unlar (Pismis)",
    object_firedUrnFlourRotten = "Curuk Un (Pismis)",
    object_firedUrnFlourRotten_plural = "Curuk Unlar (Pismis)",
    ...
    resource_flatbreadRotten = "Curuk Ekmek",
    resource_flatbreadRotten_plural = "Curuk Ekmekler",
    ...
    resource_unfiredUrnWet = "Yas Vazo",
    resource_unfiredUrnWet_plural = "Yas Vazolar",
    resource_unfiredUrnDry = "Vazo (sertlesmemis)",
    resource_unfiredUrnDry_plural = "Vazolar (sertlesmemis)",
    resource_firedUrn = "Vazo",
    resource_firedUrn_plural = "Vazolar",
    resource_unfiredUrnHulledWheat = "Kabuklu Bugday (Pismemis)",
    resource_unfiredUrnHulledWheat_plural = "Kabuklu Bugdaylar (Pismemis)",
    resource_unfiredUrnHulledWheatRotten = "Curuk Kabuklu Bugday (Pismemis)",
    resource_unfiredUrnHulledWheatRotten_plural = "Curuk Kabuklu Bugdaylar (Pismemis)",
    resource_firedUrnHulledWheat = "Kabuklu Bugday (Pismis)",
    resource_firedUrnHulledWheat_plural = "Kabuklu Bugdaylar (Pismis)",
    resource_firedUrnHulledWheatRotten = "Curuk Kabuklu Bugday (Pismis)",
    resource_firedUrnHulledWheatRotten_plural = "Curuk Kabuklu Bugdaylar (Pismis)",
    resource_quernstone = "Quern Tasi",
    resource_quernstone_plural = "Quern Taslari",
    resource_unfiredUrnFlour = "Un (Pismemis)",
    resource_unfiredUrnFlour_plural = "Unlar (Pismemis)",
    resource_unfiredUrnFlourRotten = "Curuk Un (Pismemis)",
    resource_unfiredUrnFlourRotten_plural = "Curuk Unlar (Pismemis)",
    resource_firedUrnFlour = "Un (Pismis)",
    resource_firedUrnFlour_plural = "Unlar (Pismis)",
    resource_firedUrnFlourRotten = "Curuk Un (Pismis)",
    resource_firedUrnFlourRotten_plural = "Curuk Unlar (Pismis)",
    ...
    resource_group_urnHulledWheat = "Kabuklu Bugday",
    resource_group_urnHulledWheat_plural = "Kabuklu Bugdaylar",
    ...
    skill_mudBrickBuilding = "Kil Tugla Bina",
    skill_mudBrickBuilding_description = "Kil Tuglalarla yapilar insa edin.",
